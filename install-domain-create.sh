...
$JAVA_HOME/bin/java -jar  $MIDDLEWARE/fmw_12.2.1.2.0_wls.jar  -silent -responseFile $PWD/weblogic-install/response.rsp -invPtrLoc $PWD/weblogic-install/oraInst.loc
